        ...
        try:
            while True:
                ...
                if res.pose_landmarks:
                    ...
                    # ★★ HARD-LIMIT TILT TO ±50 DEG ★★
                    tilt_output = max(min(tilt_output, 50), -50)  # clamp
                    ...
                    if time.time() - last_seen_time > LOST_TIMEOUT:
                        ...
                        # ★★ Ensure it never drifts beyond ±50 deg even while coasting ★★
                        tilt_output = max(min(tilt_output, 50), -50)

                # ── Encode + send to BLE base ─────────────
                ...
                advertiser.update_pan( pan_dir  * 1000 + pan_off )
                advertiser.update_tilt(tilt_dir * 1000 + tilt_off)
